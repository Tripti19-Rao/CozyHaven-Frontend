    ...
    if (isEmpty(errors)) {
      ...
      try {
        ...
        formData.amenities.forEach((id) =>
          finalFormData.append("amenities", id)
        );
        ...
        Object.entries(formData.profilePic).forEach((ele) =>
          finalFormData.append("profilePic", ele[1])
        );
        Object.entries(formData.license).forEach((ele) =>
          finalFormData.append("license", ele[1])
        );
        Object.entries(formData.amenitiesPic).forEach((ele) =>
          finalFormData.append("amenitiesPic", ele[1])
        );
        ...
        const response = await axios.post(
          "http://localhost:3055/api/buildings",
          finalFormData,
          {
            headers: {
          ...
          <div style={{ marginLeft: "250px" }}>
            ...
            >
              ...
              {formData.amenitiesPic.length > 0 ? (
                <p>
                  Selected files: {formData.amenitiesPic.length} files selected
                </p>
              ) : null}
              <TextField
                margin="dense"
